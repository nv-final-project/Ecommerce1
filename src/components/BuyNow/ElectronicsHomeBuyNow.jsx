...
import { bestOfElectronicsHome } from "../../utils/data.js";
import { useParams } from 'react-router-dom';


const ElectronicsHomeBuyNow = () => {
    const { id } = useParams();  // Get the product ID from the URL params
    const [product, setProduct] = useState("");

    useEffect(() => {
        // Find the product by the ID from the params
        const selectedProduct = bestOfElectronicsHome.find(product => product.id === id);
...
export default ElectronicsHomeBuyNow;